...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [LAYER_NAVIGATION] = LAYOUT_34_and_encoder(
        LSFT(KC_TAB),  XXXXXXX,  KC_AT,        KC_PERCENT,  XXXXXXX,  /**/  KC_GRAVE,  KC_TAB,         LCTL(KC_BSPC),  KC_DELETE,  KC_BACKSPACE,
        KC_CIRC,       KC_HASH,  KC_ASTERISK,  KC_DOLLAR,   XXXXXXX,  /**/  KC_LEFT,   KC_DOWN,        KC_UP,          KC_RIGHT,   KC_ENTER,
        KC_HOME,       KC_PGDN,  KC_PGUP,      KC_END,      KC_LGUI,  /**/  KC_LGUI,   KC_UNDERSCORE,  KC_SEMICOLON,   KC_TILDE,   KC_BSLS,
        /**/      /**/      KC_TRNS,      MO(LAYER_TOP),  KC_TRNS,       KC_BTN3,  KC_TRNS,        KC_TRNS,        KC_TRNS
    ),
    [LAYER_NUMBERS] = LAYOUT_34_and_encoder(
        KC_8,     KC_7,     KC_6,  KC_5,  KC_PLUS,   /**/   XXXXXXX,  KC_LCBR,  KC_RCBR,  KC_AMPR,  KC_BSPC,
        KC_4,     KC_3,     KC_2,  KC_1,  KC_EQL,    /**/   XXXXXXX,  KC_LPRN,  KC_RPRN,  KC_PIPE,  KC_ENTER,
        KC_LBRC,  KC_RBRC,  KC_9,  KC_0,  KC_MINUS,  /**/   XXXXXXX,  KC_LT,    KC_GT,    KC_COLON, KC_EXLM,
        /**/  /**/  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  MO(LAYER_TOP),  KC_TRNS
    ),
    [LAYER_TOP] = LAYOUT_34_and_encoder(
        KC_F1,  KC_F2,   KC_F3,   KC_F4,   XXXXXXX,  /**/  DF(LAYER_BASE_QWERTY),    LGUI(LCTL(KC_1)),  LGUI(LCTL(KC_2)),  XXXXXXX,     XXXXXXX,
        KC_F5,  KC_F6,   KC_F7,   KC_F8,   XXXXXXX,  /**/  DF(LAYER_BASE_COLEMAK),   LGUI(KC_1),        LGUI(KC_2),        LGUI(KC_3),  LGUI(KC_4),
        KC_F9,  KC_F10,  KC_F11,  KC_F12,  KC_F13,   /**/  DF(LAYER_BASE_GRAPHITE),  XXXXXXX,           XXXXXXX,           XXXXXXX,     XXXXXXX,
        /**/  /**/  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS
    )
};
